...
def get_loss(loss_name):
    if loss_name == 'BCEWithDigits':
        return nn.BCEWithLogitsLoss()
    elif loss_name == 'FocalLossWithDigits':
        return MixedLoss(10, 2)
    elif loss_name == 'BCEDiceWithLogitsLoss':
        return BCEDiceWithLogitsLoss()
    elif loss_name == 'BCEJaccardWithLogitsLoss':
        return BCEJaccardWithLogitsLoss()